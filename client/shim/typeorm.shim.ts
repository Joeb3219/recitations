...
export function ManyToMany(typeFunction=null, inverseSideOrOptions=null, options=null) {
    return function (object, propertyName) {
    };
}
// exports.ManyToMany = ManyToMany;

export function ManyToOne(typeFunction=null, inverseSideOrOptions=null, options=null) {
    return function (object, propertyName) {
    };
}
// exports.ManyToOne = ManyToOne;

export function OneToMany(typeFunction=null, inverseSideOrOptions=null, options=null) {
    return function (object, propertyName) {
    };
}
// exports.OneToMany = OneToMany;

export function OneToOne(typeFunction=null, inverseSideOrOptions=null, options=null) {
    return function (object, propertyName) {
    };
}
